...
//        System.out.println("" + p1);
        ...
        for (int i = 1; i <= anzahl; i++) {
            ...
            Patienten pa = new Patienten(map);
            System.out.print("Bitte eingeben nach welchen TNM-Type sortiert werden soll: (T,N,M) ");
            String tnmtype = br.readLine();
            map = pa.getPatient(new EnumComparator(), tnmtype);
